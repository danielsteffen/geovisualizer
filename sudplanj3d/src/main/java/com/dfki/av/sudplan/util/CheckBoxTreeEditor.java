 ...
 * @since 1.6
 */
public class CheckBoxTreeEditor extends JCheckBox implements ActionListener, TreeCellEditor,
            TreeSelectionListener{
    private final static Logger logger = LoggerFactory.getLogger(CheckBoxTreeEditor.class);
/** Editor handling the editing. */
     ...
     */
    public CheckBoxTreeEditor(JTree tree,
     ...
     */
    public CheckBoxTreeEditor(JTree tree, DefaultTreeCellRenderer renderer,
	...
	public Dimension getPreferredSize() {
	    ...
	    if(renderer != null &&
	       CheckBoxTreeEditor.this.getFont() == null) {
