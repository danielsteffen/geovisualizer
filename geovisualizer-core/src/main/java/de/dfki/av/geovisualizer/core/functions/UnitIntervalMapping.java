...
/**
 * Transfer function used to map the values of a data set to the unit interval
 * and provide the possibility to scale the values afterwards.
 *
 * @author Daniel Steffen <daniel.steffen at dfki.de>
 */
public class UnitIntervalMapping extends ScalarMultiplication {

    /*
     * The logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(UnitIntervalMapping.class);
    /**
    ...
    public String getName() {
        return "Unit Interval Mapping - f(x) = a * (x - min) / |max-min|";
    }
