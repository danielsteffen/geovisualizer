...
public class VisParameter {
    ...
    /**
     * The description name of this visualization parameter.
     */
    private String name;
        
    /**
     * Creates object <code>VisParameter</code> with the name {@link #name}.
     * 
     * @param name the name of the <code>VisParameter</code>.
     * @throws IllegalArgumentException if parameter <code>name</code> 
