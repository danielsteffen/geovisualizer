...
public class ComponentFactory {
   ...
   */
  public static JFrame getStandaloneApplication(ApplicationConfiguration configuration) throws InitialisationException {
    ...
    ComponentController compControl;
    try {
      compControl = new ComponentController(newApplicatioFrame.getVisualisationComponent(), configuration);
