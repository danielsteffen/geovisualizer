...
import com.dfki.av.sudplan.ui.SimpleLayerPanel.LayerNode;
 ...
 * @since 1.6
 */
public class CheckBoxTreeRenderer //extends JLabel implements TreeCellRenderer
{

//    private final static Logger logger = LoggerFactory.getLogger(CheckBoxTreeRenderer.class);
//    private JTree tree;
...
////            setSelected(layerNode.getLayer().isVisible());
//        }
//
//        if (!tree.isEnabled()) {
//            setEnabled(false);
